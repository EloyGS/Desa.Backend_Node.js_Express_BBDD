...
// View to delete a register
/*const deleteView = (quiz) => {
    // .... introducir código
    return `<!doctype html>
    <html>
        <head>
        ...
        <body>
            ...
            <form method="POST" action="/quizzes/${quiz.id}?_method=DELETE">
                    ...
                    <label for="answer">Answer:</label>
                    <input type="text" name="answer" value="${quiz.answer}" readonly>
...
const destroyController = async (req, res, next) => {
    ...
    try {
        ...
        //const quiz = await Quiz.findByPk(id);   
        //await quiz.delete({ question, answer });
        //await quiz.save();    
        //res.send(deleteView(Quiz));
...
app.get('/quizzes/:id/edit', editController); //new
app.put('/quizzes/:id', updateController); //new
app.delete('/quizzes/:id', destroyController) //new
//app.delete('/quizzes/:id/delete', destroyController); //new
